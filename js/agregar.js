...
const expresiones = {
    ...
    url: /^[a-zA-Z0-9\s\.]{1,100}$/, // Letra, numeros y 
...
const validarFormulario = (e) =>{
    switch(e.target.name){
        ...
        case "url":
            ValidacionCampos(expresiones.url, e.target, 'Url');
        break;
...
formulario.addEventListener('submit', (e) => { 
    ...
    if(campos.Sku && campos.Nombre && campos.Precio && campos.Cantidad && campos.Proveedor && campos.Descripcion && campos.tipo && campos.Url){   
